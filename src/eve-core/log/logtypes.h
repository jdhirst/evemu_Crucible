...
LOG_CATEGORY( MISSION )
LOG_TYPE( MISSION, ERROR,   ENABLED, "MissionError" )
LOG_TYPE( MISSION, WARNING, DISABLED, "MissionWarning" )
LOG_TYPE( MISSION, MESSAGE, DISABLED, "MissionMsg" )
LOG_TYPE( MISSION, INFO, DISABLED, "MissionInfo" )
LOG_TYPE( MISSION, DEBUG, DISABLED, "MissionDebug" )
LOG_TYPE( MISSION, TRACE, DISABLED, "MissionTrace" )
